...
/**
 * JUnit Test aspect that creates an embedded ActiveMQ broker at the beginning
 * of eac h test and shuts it down after.
 */
public class EmbeddedActiveMQBroker extends ExternalResource {
	...
	public EmbeddedActiveMQBroker(String brokerId) {
		...
		tcpConnectorUri = "tcp://localhost:" + AvailablePortFinder.getNextAvailable(61619);
